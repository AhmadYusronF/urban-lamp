...
import collaborationsRepositories from '../../collaborations/repositories/collaborations-repositories.js';
...
GROUP BY notes.id`,
  ...
  async verifyNoteAccess(noteId, userId) {
    const onwerResult = await this.verifyNoteOwner(noteId, userId);
    if (onwerResult) {
      return onwerResult;
    }

    const result = await this.collaborationsRepositories.verifyCollaborator(
      noteId,
      userId,
    );
